...
Example Usage:
--------------
predicted_class, confidence = predict(model, sample_image)
...
-------
Mounika Poola
Graduate Student | Bioinformatics & IT | AI/ML Enthusiast

---------------------------------------------------

Notes:
------
- Make sure to define dataset_dir, class_labels, and images properly.
- Folder names should match the class labels.
